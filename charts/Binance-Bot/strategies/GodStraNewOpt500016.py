...
class GodStraNewOpt500016(IStrategy):
    # #################### RESULTS PASTE PLACE ####################
    ...
    buy_crossed_indicator0 = CategoricalParameter(
        god_genes_with_timeperiod, default="SMA-55", space='buy')
    buy_crossed_indicator1 = CategoricalParameter(
        god_genes_with_timeperiod, default="SMA-110", space='buy')
    ...
    buy_indicator2 = CategoricalParameter(
        god_genes_with_timeperiod, default="SMA-6", space='buy')

    buy_operator0 = CategoricalParameter(operators, default="D", space='buy')
    buy_operator1 = CategoricalParameter(operators, default="D", space='buy')
    buy_operator2 = CategoricalParameter(operators, default="<R", space='buy')

    buy_real_num0 = DecimalParameter(0, 1, decimals=DECIMALS,  default=0.6, space='buy')
    buy_real_num1 = DecimalParameter(0, 1, decimals=DECIMALS, default=0.0, space='buy')
    buy_real_num2 = DecimalParameter(0, 1, decimals=DECIMALS, default=0.6, space='buy')

    # Sell Hyperoptable Parameters/Spaces.
    sell_crossed_indicator0 = CategoricalParameter(
        god_genes_with_timeperiod, default="SMA-5", space='sell')
    sell_crossed_indicator1 = CategoricalParameter(
        god_genes_with_timeperiod, default="SMA-5", space='sell')
    sell_crossed_indicator2 = CategoricalParameter(
        god_genes_with_timeperiod, default="SMA-100", space='sell')

    sell_indicator0 = CategoricalParameter(
        god_genes_with_timeperiod, default="SMA-12", space='sell')
    sell_indicator1 = CategoricalParameter(
        god_genes_with_timeperiod, default="SMA-110", space='sell')
    sell_indicator2 = CategoricalParameter(
        god_genes_with_timeperiod, default="SMA-6", space='sell')

    sell_operator0 = CategoricalParameter(operators, default=">R", space='sell')
    sell_operator1 = CategoricalParameter(operators, default="CA", space='sell')
    sell_operator2 = CategoricalParameter(operators, default=">R", space='sell')

    sell_real_num0 = DecimalParameter(0, 1, decimals=DECIMALS, default=0.1, space='sell')
    sell_real_num1 = DecimalParameter(0, 1, decimals=DECIMALS, default=0.3, space='sell')
    sell_real_num2 = DecimalParameter(0, 1, decimals=DECIMALS, default=0.6, space='sell')
